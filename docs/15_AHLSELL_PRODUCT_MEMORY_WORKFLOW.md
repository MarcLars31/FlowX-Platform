...
3. A user reviews and confirms each requirement.
4. An authorized distributor user enters:
   - product name;
   - Ahlsell article number;
   - optional manufacturer;
   - internal reasoning;
   - zero or more accessory names, article numbers and quantities.
5. The project receives a selected product snapshot.
6. The same decision is stored in organization-scoped product memory.
7. When a later confirmed requirement has the same normalized technical
