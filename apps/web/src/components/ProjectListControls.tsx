...
export function ProjectListControls({
  ...
  return (
    <>
      <div className="grid gap-3 border-b border-ink-200 bg-ink-50 p-4 md:grid-cols-[minmax(0,2fr)_repeat(3,minmax(0,1fr))]">
