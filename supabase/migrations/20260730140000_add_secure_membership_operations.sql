...
begin
  ...
  if actor_is_admin and (
    not target_role_is_system
    or requested_role_slug not in ('full_user', 'mini_user', 'read_only')
  ) then
...
begin
  ...
  if actor_is_admin and (
    current_role_slug in ('organization_owner', 'organization_admin')
...
begin
  ...
  if actor_is_admin
    and target_role_slug in ('organization_owner', 'organization_admin') then
